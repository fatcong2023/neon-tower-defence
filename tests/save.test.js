...
describe('campaign saves', () => {
  it('round-trips progress, research, and language', () => {
    ...
    Object.assign(campaign, { currentLevel: 23, highestCleared: 22, coreChips: 91, research: ['pulse-1'] });

    const restored = parseSave(serializeSave(campaign));

    expect(restored).toMatchObject({ version: SAVE_VERSION, seed: 42, currentLevel: 23, highestCleared: 22, coreChips: 91, language: 'en' });
